...
<img src="<?= htmlspecialchars($hotel_data['id'] == 4 ? 'images/CITY/Standar.jpg' : ($hotel_data['gambar'] ?? 'images/default_hotel.jpg')) ?>" alt="<?= htmlspecialchars($hotel_data['nama']) ?>">      <div class="hotel-info">
